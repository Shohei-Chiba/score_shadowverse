...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { Ahead: @deck.Ahead, Opponentdeck: @deck.Opponentdeck, mydeck: @deck.mydeck, result: @deck.result } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { Ahead: @deck.Ahead, Opponentdeck: @deck.Opponentdeck, mydeck: @deck.mydeck, result: @deck.result } }
